package br.com.dentalofficemanager.web.DTO;
...
public class PatientDTO implements Serializable{
	...
	public String toString() {
		return "PatientDTO [firstName=" + firstName + ", lastName=" + lastName + ", birthDate=" + birthDate + ", cpf="
				+ cpf + ", phoneNumber=" + phoneNumber + ", cellPhoneNumber=" + cellPhoneNumber + ", email=" + email
				+ ", addressStreet=" + addressStreet + ", addressDistrict=" + addressDistrict + ", addressCity="
				+ addressCity + ", addressState=" + addressState + ", addressZipCode=" + addressZipCode
				+ ", addressNumber=" + addressNumber + ", addressAdditionalInfo=" + addressAdditionalInfo + "]";
	}
}
